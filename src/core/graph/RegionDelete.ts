...
export default class RegionDelete implements RegionDeleteInterface {
    ...
    private _startDraw: Function = (event: PIXI.InteractionEvent) => {
    ...
    private _drawing: Function = (event: PIXI.InteractionEvent) => {
        if (this._startDown) {
    ...
    private _endDraw: Function = (event: PIXI.InteractionEvent) => {
        if (this._startDown) {
